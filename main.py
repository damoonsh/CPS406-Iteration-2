        ...
        def _random_position(self):
            ...
            if random.choice([0, 1]) == 0:
                ...
                if x == consts.MARGIN: # to set initial direction
                    ...
                    self.dir = 'right'
                y = random.randrange(consts.MARGIN // consts.SPARX_DIM, (consts.MAP_HEIGHT - consts.MARGIN) // consts.SPARX_DIM) * 5
                return x, y, 'vertical'
            else:
                x = random.randrange(consts.MARGIN // consts.SPARX_DIM, (consts.MAP_WIDTH - consts.MARGIN) // consts.SPARX_DIM) * 5
